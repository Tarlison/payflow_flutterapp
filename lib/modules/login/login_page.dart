...
import 'package:payflow_flutterapp/modules/login/login_controller.dart';
...
import 'package:payflow_flutterapp/shared/widgets/social_login/social_login_button.dart';
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Stack(
          children: [
            Container(
              //container laranja parte de cima
              width: size.width,
